...
<div class="container m-auto text-center pt-10 pb-5">
        <h1 class="font-bold text-6xl ">Edit Your Post</h1>
    </div>
    <div class="container mx-auto p-8 bg-white shadow-2xl rounded-lg max-w-lg mt-10 mb-10">
        ...
        @method('PUT')
            ...
            <textarea
                name="description" 
                class="w-full h-60 px-4 text-lg border border-gray-300 rounded-lg mb-6 focus:outline-none focus:ring-2 focus:ring-blue-500">
                {{$post->description}}
            </textarea>
            <div class="py-10">
